"""Material enrichment generation (bounded content index and topics)."""
...
from .schemas import EnrichmentGenerationResult, MATERIAL_ENRICHMENT_KINDS


DEFAULT_PROCESSOR_VERSION = "1.2.0"
DEFAULT_MAX_MATERIAL_CHUNKS = 16


class MaterialEnrichmentGenerator:
    """Pure worker-side material content-index generator."""
    ...
    def __init__(
        ...
        *,
        ...
        max_chunks: int | None = DEFAULT_MAX_MATERIAL_CHUNKS,
    ) -> None:
    ...
    def generate(
        ...
        *,
        ...
        result = call_enrichment_adapter(self.adapter, "material", derivative, context.chunks)
        return build_generation_result(
            context=context,
            llm_result=result,
            required_kinds=MATERIAL_ENRICHMENT_KINDS,
...
def generate_material_enrichment(
    derivative: Any,
    ...
    *,
    ...
    """Generate and validate one material enrichment result."""
    ...
    return MaterialEnrichmentGenerator(
        actual_adapter,
...
def _looks_like_adapter(value: Any) -> bool:
    return callable(getattr(value, "enrich_material", None))
...
generate_material = generate_material_enrichment
enrich_material = generate_material_enrichment
MaterialEnricher = MaterialEnrichmentGenerator


__all__ = [
    "DEFAULT_MAX_MATERIAL_CHUNKS",
    "DEFAULT_PROCESSOR_VERSION",
    "MaterialEnrichmentGenerator",
    "MaterialEnricher",
    "enrich_material",
    "generate_material",
    "generate_material_enrichment",
]
